...
sql_create_table = "CREATE TABLE ipocrawler (id serial not null primary key, market char(20) not NULL, stock_code char(20) not NULL, stock_name char(20) not NULL, total_issued char(20) not NULL, public_price char(20) not NULL, lots_size char(20) not NULL, currency char(20) not NULL, subscription_date_start char(20) not NULL, subscription_date_end char(20) not NULL, public_date char(20) not NULL);"
